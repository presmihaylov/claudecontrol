...
export default function SelfManagedPage() {
	...
	// Authenticate user with backend and fetch organization when they first sign in
	useEffect(() => {
		const authenticateUserAndFetchOrganization = async () => {
		...
		authenticateUserAndFetchOrganization();
						...
						<CardContent className="space-y-4">
							...
							<div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border rounded-lg bg-muted/50 gap-4">
								...
								<Button
									variant="outline"
									onClick={() =>
										window.open("https://github.com/presmihaylov/ccagent#installation", "_blank")
									}
									className="flex items-center gap-2 w-full sm:w-auto"
								>
