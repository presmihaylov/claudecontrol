...
// CommitMessagePrompt generates a prompt for Claude to create commit messages
...
// PRTitlePrompt generates a prompt for Claude to create PR titles
...
// PRBodyPrompt generates a prompt for Claude to create PR descriptions
...
// UpdatedPRTitlePrompt generates a prompt for Claude to update existing PR titles
...
// UpdatedPRDescriptionPrompt generates a prompt for Claude to update existing PR descriptions
