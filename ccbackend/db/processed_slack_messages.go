...
func (r *PostgresProcessedSlackMessagesRepository) CreateProcessedSlackMessage(
	...
	err := db.QueryRowxContext(ctx, query, message.ID, message.JobID, message.SlackChannelID, message.SlackTS, message.TextContent, message.Status, message.SlackIntegrationID, message.OrgID).
		StructScan(message)
	if err != nil {
...
func (r *PostgresProcessedSlackMessagesRepository) UpdateProcessedSlackMessageStatus(
	...
	message := &models.ProcessedSlackMessage{}
	err := db.QueryRowxContext(ctx, query, id, status, slackIntegrationID, orgID).StructScan(message)
	if err != nil {
		if err == sql.ErrNoRows {
			return mo.None[*models.ProcessedSlackMessage](), nil
		}
...
func (r *PostgresProcessedSlackMessagesRepository) GetProcessedSlackMessagesByJobID(
	...
	err := db.SelectContext(ctx, &messages, query, jobID, slackIntegrationID, orgID)
	if err != nil {
...
func (r *PostgresProcessedSlackMessagesRepository) DeleteProcessedSlackMessagesByJobID(
	...
	_, err := db.ExecContext(ctx, query, jobID, slackIntegrationID, orgID)
	if err != nil {
...
func (r *PostgresProcessedSlackMessagesRepository) GetProcessedMessagesByJobIDAndStatus(
	...
	var messages []*models.ProcessedSlackMessage
	err := db.SelectContext(ctx, &messages, query, jobID, status, slackIntegrationID, orgID)
	if err != nil {
...
func (r *PostgresProcessedSlackMessagesRepository) GetLatestProcessedMessageForJob(
	...
	message := &models.ProcessedSlackMessage{}
	err := db.GetContext(ctx, message, query, jobID, slackIntegrationID, orgID)
	if err != nil {
		if err == sql.ErrNoRows {
			return mo.None[*models.ProcessedSlackMessage](), nil
		}
