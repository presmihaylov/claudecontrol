...
// MockAgentsService implements AgentsService for testing
...
func (m *MockAgentsService) GetInactiveAgents(
	...
	args := m.Called(ctx, organizationID, inactiveTimeoutMinutes)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).([]*models.ActiveAgent), args.Error(1)
...
func (m *MockAgentsService) DeleteActiveAgent(
	ctx context.Context,
	agentID, organizationID string,
) error {
	args := m.Called(ctx, agentID, organizationID)
...
func (m *MockAgentsService) CheckAgentHasActiveConnection(
...
func (m *MockAgentsService) AssignAgentToJob(
	ctx context.Context,
	agentID, jobID, organizationID string,
) error {
