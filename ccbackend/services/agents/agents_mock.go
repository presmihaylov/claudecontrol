...
func (m *MockAgentsService) UpsertActiveAgent(ctx context.Context, wsConnectionID, organizationID, agentID string) (*models.ActiveAgent, error) {
...
func (m *MockAgentsService) GetAgentByID(ctx context.Context, id, organizationID string) (mo.Option[*models.ActiveAgent], error) {
	args := m.Called(ctx, id, organizationID)
...
func (m *MockAgentsService) GetAgentByJobID(ctx context.Context, jobID, organizationID string) (mo.Option[*models.ActiveAgent], error) {
...
func (m *MockAgentsService) GetActiveAgentJobAssignments(ctx context.Context, agentID, organizationID string) ([]string, error) {
