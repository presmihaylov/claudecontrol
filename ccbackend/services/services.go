...
// OrganisationsService defines the interface for organization-related operations
type OrganisationsService interface {
	CreateOrganisation(ctx context.Context) (*models.Organisation, error)
	GetOrganisationByID(ctx context.Context, id string) (mo.Option[*models.Organisation], error)
}
