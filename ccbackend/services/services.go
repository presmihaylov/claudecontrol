...
type JobsService interface {
	GetActiveMessageCountForJobs(ctx context.Context, jobIDs []string, organizationID string) (int, error)
	CreateJob(
		ctx context.Context,
		slackThreadTS, slackChannelID, slackUserID, slackIntegrationID string,
	) (*models.Job, error)
	GetJobByID(ctx context.Context, id string, organizationID string) (mo.Option[*models.Job], error)
	GetJobBySlackThread(
		ctx context.Context,
	...
	TESTS_UpdateJobUpdatedAt(ctx context.Context, id string, updatedAt time.Time, organizationID string) error
	...
	GetJobsWithQueuedMessages(ctx context.Context, organizationID string) ([]*models.Job, error)
