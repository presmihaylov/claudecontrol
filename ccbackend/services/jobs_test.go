...
func TestJobsService(t *testing.T) {
	...
	t.Run("GetJobByID", func(t *testing.T) {
		...
		t.Run("NilUUID", func(t *testing.T) {
			_, err := service.GetJobByID("", slackIntegrationID)
		...
		t.Run("EmptySlackIntegrationID", func(t *testing.T) {
			_, err := service.GetJobByID(core.NewID("j"), "")
	...
	t.Run("DeleteJob", func(t *testing.T) {
		...
		t.Run("NilUUID", func(t *testing.T) {
			err := service.DeleteJob("", slackIntegrationID)
		...
		t.Run("EmptySlackIntegrationID", func(t *testing.T) {
			err := service.DeleteJob(core.NewID("j"), "")
...
func TestJobsAndAgentsIntegration(t *testing.T) {
	...
	t.Run("MultipleAgentsJobAssignment", func(t *testing.T) {
		...
		updatedAgent1, err := agentsService.GetAgentByID(context.Background(), agent1.ID, slackIntegrationID)
		require.NoError(t, err)
		...
		updatedAgent2, err := agentsService.GetAgentByID(context.Background(), agent2.ID, slackIntegrationID)
		require.NoError(t, err)
	...
	t.Run("GetAgentByJobID", func(t *testing.T) {
		...
		foundAgent, err := agentsService.GetAgentByJobID(context.Background(), job.ID, slackIntegrationID)
		require.NoError(t, err)
	...
	t.Run("GetAgentByWSConnectionID", func(t *testing.T) {
		...
		foundAgent, err := agentsService.GetAgentByWSConnectionID(context.Background(), wsConnectionID, slackIntegrationID)
		require.NoError(t, err)
		assert.Equal(t, agent.ID, foundAgent.ID)
		...
		_, err = agentsService.GetAgentByWSConnectionID(context.Background(), core.NewID("wsc"), slackIntegrationID)
		require.Error(t, err)
		assert.True(t, errors.Is(err, core.ErrNotFound))
	...
	t.Run("UpdateJobTimestamp", func(t *testing.T) {
		...
		err = jobsService.UpdateJobTimestamp("", slackIntegrationID)
		require.Error(t, err)
		assert.Contains(t, err.Error(), "job ID must be a valid ULID")
	})
	...
	t.Run("CreateProcessedSlackMessage", func(t *testing.T) {
		...
		t.Run("NilJobID", func(t *testing.T) {
			_, err := jobsService.CreateProcessedSlackMessage("", "C1234567890", "1234567890.123456", "Hello world", slackIntegrationID, models.ProcessedSlackMessageStatusQueued)
	...
	t.Run("UpdateProcessedSlackMessage", func(t *testing.T) {
		...
		t.Run("NilID", func(t *testing.T) {
			_, err := jobsService.UpdateProcessedSlackMessage("", models.ProcessedSlackMessageStatusCompleted, slackIntegrationID)
	...
	t.Run("DeleteJobWithAgentAssignment", func(t *testing.T) {
		...
		// Verify assignment
		assignedAgent, err := agentsService.GetAgentByJobID(context.Background(), job.ID, slackIntegrationID)
		require.NoError(t, err)
		...
		remainingAgent, err := agentsService.GetAgentByID(context.Background(), agent.ID, slackIntegrationID)
		require.NoError(t, err)
