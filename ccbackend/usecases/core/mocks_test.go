...
// Type aliases for mock function types
type MessageHandlerFunc = clients.MessageHandlerFunc
type ConnectionHookFunc = clients.ConnectionHookFunc
type PingHandlerFunc = clients.PingHandlerFunc
...
func (m *MockJobsService) GetActiveMessageCountForJobs(ctx context.Context, jobIDs []string, slackIntegrationID string, organizationID string) (int, error) {
...
func (m *MockJobsService) GetJobByID(ctx context.Context, id string, organizationID string) (mo.Option[*models.Job], error) {
	args := m.Called(ctx, id, organizationID)
...
func (m *MockJobsService) CreateProcessedSlackMessage(ctx context.Context, jobID string, slackChannelID, slackTS, textContent, slackIntegrationID, organizationID string, status models.ProcessedSlackMessageStatus) (*models.ProcessedSlackMessage, error) {
...
func (m *MockJobsService) UpdateProcessedSlackMessage(ctx context.Context, id string, status models.ProcessedSlackMessageStatus, slackIntegrationID string, organizationID string) (*models.ProcessedSlackMessage, error) {
...
func (m *MockJobsService) GetProcessedMessagesByJobIDAndStatus(ctx context.Context, jobID string, status models.ProcessedSlackMessageStatus, slackIntegrationID string, organizationID string) ([]*models.ProcessedSlackMessage, error) {
...
func (m *MockJobsService) GetProcessedSlackMessageByID(ctx context.Context, id string, organizationID string) (mo.Option[*models.ProcessedSlackMessage], error) {
	args := m.Called(ctx, id, organizationID)
	return args.Get(0).(mo.Option[*models.ProcessedSlackMessage]), args.Error(1)
}

func (m *MockJobsService) TESTS_UpdateJobUpdatedAt(ctx context.Context, jobID string, updatedAt time.Time, slackIntegrationID string, organizationID string) error {
	args := m.Called(ctx, jobID, updatedAt, slackIntegrationID, organizationID)
	return args.Error(0)
}

func (m *MockJobsService) GetJobsWithQueuedMessages(ctx context.Context, slackIntegrationID string, organizationID string) ([]*models.Job, error) {
...
func (m *MockJobsService) GetLatestProcessedMessageForJob(ctx context.Context, jobID string, slackIntegrationID string, organizationID string) (mo.Option[*models.ProcessedSlackMessage], error) {
	args := m.Called(ctx, jobID, slackIntegrationID, organizationID)
	return args.Get(0).(mo.Option[*models.ProcessedSlackMessage]), args.Error(1)
}

func (m *MockJobsService) TESTS_UpdateProcessedSlackMessageUpdatedAt(ctx context.Context, id string, updatedAt time.Time, slackIntegrationID string, organizationID string) error {
...
func (m *MockSlackIntegrationsService) CreateSlackIntegration(ctx context.Context, organizationID, slackAuthCode, redirectURL string) (*models.SlackIntegration, error) {
...
func (m *MockSocketIOClient) RegisterClient(client *clients.Client) error {
...
func (m *MockSocketIOClient) GetClient(clientID string) (mo.Option[*clients.Client], error) {
	args := m.Called(clientID)
	return args.Get(0).(mo.Option[*clients.Client]), args.Error(1)
}
...
func (m *MockSlackUseCase) ProcessSlackMessageEvent(ctx context.Context, event models.SlackMessageEvent, slackIntegrationID string, organizationID string) error {
	args := m.Called(ctx, event, slackIntegrationID, organizationID)
	return args.Error(0)
}

func (m *MockSlackUseCase) ProcessReactionAdded(ctx context.Context, reactionName, userID, channelID, messageTS, slackIntegrationID string, organizationID string) error {
	args := m.Called(ctx, reactionName, userID, channelID, messageTS, slackIntegrationID, organizationID)
	return args.Error(0)
}

func (m *MockSlackUseCase) ProcessProcessingMessage(ctx context.Context, clientID string, payload models.ProcessingMessagePayload, organizationID string) error {
	args := m.Called(ctx, clientID, payload, organizationID)
	return args.Error(0)
}

func (m *MockSlackUseCase) ProcessAssistantMessage(ctx context.Context, clientID string, payload models.AssistantMessagePayload, organizationID string) error {
	args := m.Called(ctx, clientID, payload, organizationID)
	return args.Error(0)
}

func (m *MockSlackUseCase) ProcessSystemMessage(ctx context.Context, clientID string, payload models.SystemMessagePayload, organizationID string) error {
	args := m.Called(ctx, clientID, payload, organizationID)
	return args.Error(0)
}

func (m *MockSlackUseCase) ProcessJobComplete(ctx context.Context, clientID string, payload models.JobCompletePayload, organizationID string) error {
	args := m.Called(ctx, clientID, payload, organizationID)
	return args.Error(0)
}
...
func (m *MockSlackUseCase) CleanupFailedSlackJob(ctx context.Context, job *models.Job, agentID string, message string) error {
	args := m.Called(ctx, job, agentID, message)
	return args.Error(0)
}

// MockAgentsUseCase is a mock implementation of AgentsUseCase
